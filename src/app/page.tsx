      ...
      <div className="relative z-10">
        ...
        <section id="pricing" className="px-6 md:px-16 py-24 max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p style={{ color: 'rgba(255,255,255,0.5)' }}>One flat monthly fee. Unlimited scans. You fund your reward pool — we cover ACH fees up to your plan limit, 1.5% on additional deposits.</p>
          </div>
            ...
            {[
              {
                ...
                features: ['Unlimited scans', 'Up to $500/mo in pool deposits', '1.5% on additional deposits', 'Basic analytics', 'Email support', 'Custom brand colors'],
                highlight: false,
              },
              {
                name: 'Growth', price: '$199', setup: '$299 setup', desc: 'For brands ready to scale loyalty.',
                features: ['Unlimited scans', 'Up to $2,000/mo in pool deposits', '1.5% on additional deposits', 'Full analytics + reports', 'Priority support', 'Custom brand domain'],
                highlight: true,
              },
              {
                name: 'Pro', price: '$399', setup: '$299 setup', desc: 'High-volume or multi-brand operations.',
                features: ['Unlimited scans', 'Unlimited pool deposits', 'ACH fees included', 'Multi-brand dashboard', 'Dedicated support', 'White-label everything'],
                highlight: false,
              },
