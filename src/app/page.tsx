    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <nav className="flex items-center justify-between px-6 md:px-16 py-5 border-b border-gray-100">
        ...
        <div className="flex items-center gap-6">
          <a href="#how" className="hidden md:block text-sm text-gray-500 hover:text-gray-900 transition-colors">How it works</a>
      ...
      <section className="px-6 md:px-16 pt-20 pb-24 max-w-6xl mx-auto">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <a href="#how"
              className="inline-flex items-center justify-center px-7 py-4 rounded-xl font-bold text-gray-700 text-base border border-gray-200 hover:bg-gray-50 transition-colors">
              See how it works
            </a>
          </div>
        </div>
      ...
      <section className="bg-gray-50 border-y border-gray-100 px-6 md:px-16 py-10">
        <div className="max-w-6xl mx-auto">
          <p className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-6">Trusted by</p>
          <div className="flex flex-wrap items-center gap-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Cannabis · Illinois</p>
              </div>
            </div>
            <div className="flex items-center gap-3 opacity-30">
              <div className="h-10 w-10 rounded-xl bg-gray-300" />
              <div>
                <p className="font-bold text-gray-400 text-sm">Your Brand</p>
                <p className="text-xs text-gray-300">Could be here</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="how" className="px-6 md:px-16 py-24 max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 text-lg">No loyalty cards. No app. Works at any dispensary.</p>
        </div>

        <div className="grid md:grid-cols-2 gap-16 items-center">
          {/* For consumers */}
          <div>
            <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-6">For your customers</p>
          ...
          <div className="flex justify-center">
            <div className="w-64 rounded-3xl shadow-2xl overflow-hidden border-4 border-gray-900 bg-white">
              ...
              <div className="px-4 pt-6 pb-8" style={{ background: 'linear-gradient(160deg, #6d28d9, #3730a3)' }}>
                ...
                <p className="text-white/40 text-xs mt-1">12 scans · 1 brand</p>
              </div>
              {/* Wallet card */}
              <div className="-mt-4 mx-3 rounded-2xl bg-white shadow-lg border border-gray-100 p-4 mb-3">
                ...
                <p className="text-xs text-gray-400 mb-3">$3.75 / $5.00 to cash out</p>
      ...
      <section className="bg-gray-50 border-y border-gray-100 px-6 md:px-16 py-20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-500 mb-12">Customers earn per qualifying product on the receipt.</p>
          <div className="grid sm:grid-cols-3 gap-6 max-w-2xl mx-auto">
            {[
              ...
              <div key={product} className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                ...
                <p className="font-bold text-gray-700 text-sm mb-1">{product}</p>
      ...
      <section id="pricing" className="px-6 md:px-16 py-24 max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 text-lg">One-time setup fee + monthly platform fee. You fund your own reward pool.</p>
        </div>
          ...
          {[
            ...
            <div key={name} className={`rounded-2xl p-7 border ${highlight ? 'border-gray-900 bg-gray-900 text-white shadow-2xl scale-105' : 'border-gray-100 bg-white shadow-sm'}`}>
              ...
              <div className="flex items-end gap-1 mb-1">
                ...
                <span className={`text-sm mb-1.5 ${highlight ? 'text-gray-400' : 'text-gray-400'}`}>/mo</span>
              </div>
              <p className={`text-xs mb-2 ${highlight ? 'text-gray-500' : 'text-gray-400'}`}>{setup}</p>
              <p className={`text-sm leading-relaxed mb-6 ${highlight ? 'text-gray-400' : 'text-gray-500'}`}>{desc}</p>
              <ul className="space-y-2.5 mb-8">
                {features.map(f => (
                  <li key={f} className={`text-sm flex items-center gap-2 ${highlight ? 'text-gray-300' : 'text-gray-600'}`}>
                    <span className={`text-xs ${highlight ? 'text-green-400' : 'text-green-500'}`}>✓</span>
                    {f}
                  </li>
                ))}
              </ul>
      ...
      <section className="px-6 md:px-16 py-24" style={{ background: 'linear-gradient(160deg, #1a1a2e, #0f0f1a)' }}>
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-lg mb-10">Get set up in days, not months. No technical knowledge required.</p>
          <a href="mailto:admin@ogrewards.io"
      ...
      <footer className="px-6 md:px-16 py-8 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <p className="text-xs text-gray-400">© 2026 OGRewards LLC · Chicago, IL · admin@ogrewards.io</p>
      </footer>
